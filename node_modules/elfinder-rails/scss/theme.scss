...
.elfinder-mobile .elfinder-quicklook-titlebar-icon .ui-icon.elfinder-icon-close {
	...
	border-color: #e5695d;
	background-image: asset-url("#{$elfinder-img-path}/ui-icons_ffffff_256x240.png");
}
...
.elfinder-contextmenu .ui-state-hover .elfinder-contextmenu-arrow { background-image:asset-url("#{$elfinder-img-path}/arrows-active.png"); }
