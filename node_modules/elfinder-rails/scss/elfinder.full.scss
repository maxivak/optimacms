$elfinder-img-path: "elfinder-rails/img" !default;
...
.elfinder-resize-handle-vline {
	position:absolute;
	background-image:asset-url("#{$elfinder-img-path}/crop.gif");
}
...
.elfinder-resize-spinner {
	...
	margin-left:-100px;
	text-align:center;
	background:asset-url("#{$elfinder-img-path}/progress.gif") center bottom repeat-x;
}
...
.elfinder-help-logo {
	...
	float:left;
	margin-right:1em;
	background:asset-url("#{$elfinder-img-path}/logo.png") center center no-repeat;
}
...
.elfinder.elfinder-processing.elfinder-touch .elfinder-workzone:after {
	...
	content: '';
	left: 0;
	background-image: asset-url("#{$elfinder-img-path}/progress.gif");
	opacity: .6;
	pointer-events: none;
}
...
.elfinder-symlink {
	...
	width:16px;
	height:16px;
	background-image: asset-url("#{$elfinder-img-path}/toolbar.png");
...
.elfinder-drag-helper-icon-status {
	...
	left:42px;
	top:60px;
	background:asset-url("#{$elfinder-img-path}/toolbar.png") 0 -96px no-repeat;
	display: block;
}
...
.elfinder-navbar-root-local.elfinder-contextmenu-icon { background-image:asset-url("#{$elfinder-img-path}/volume_icon_local.png"); }
.elfinder-navbar-root-ftp.elfinder-contextmenu-icon { background-image:asset-url("#{$elfinder-img-path}/volume_icon_ftp.png"); }
.elfinder-navbar-root-sql.elfinder-contextmenu-icon { background-image:asset-url("#{$elfinder-img-path}/volume_icon_sql.png"); }
.elfinder-navbar-root-dropbox.elfinder-contextmenu-icon { background-image:asset-url("#{$elfinder-img-path}/volume_icon_dropbox.png"); }
.elfinder-navbar-root-googledrive.elfinder-contextmenu-icon { background-image:asset-url("#{$elfinder-img-path}/volume_icon_googledrive.png"); }
.elfinder-navbar-root-onedrive.elfinder-contextmenu-icon { background-image:asset-url("#{$elfinder-img-path}/volume_icon_onedrive.png"); }
.elfinder-navbar-root-box.elfinder-contextmenu-icon { background-image:asset-url("#{$elfinder-img-path}/volume_icon_box.png"); }
.elfinder-navbar-root-zip.elfinder-contextmenu-icon { background-image:asset-url("#{$elfinder-img-path}/volume_icon_zip.png"); }
...
.elfinder .elfinder-contextmenu-arrow {
	width:16px;
	height:16px;
	background:asset-url("#{$elfinder-img-path}/arrows-normal.png") 5px 4px no-repeat;
}
...
.elfinder .elfinder-button-icon.ui-state-disabled {
	background-image: asset-url("#{$elfinder-img-path}/toolbar.png") !important;
}
/* File: /css/cwd.css */
/******************************************************************/
...
.elfinder-cwd-icon {
	...
	height:48px;
	margin:0 auto;
	background: asset-url("#{$elfinder-img-path}/icons-big.png") 0 0 no-repeat;
...
.elfinder-cwd-view-list .elfinder-navbar-root-local td .elfinder-cwd-icon {
	background-image:asset-url("#{$elfinder-img-path}/volume_icon_local.png");
...
.elfinder-cwd-view-list .elfinder-navbar-root-trash td .elfinder-cwd-icon {
	background-image:asset-url("#{$elfinder-img-path}/volume_icon_trash.png");
	background-position:0 0;
	background-size: contain;
}
.elfinder-cwd .elfinder-navbar-root-trash.elfinder-droppable-active .elfinder-cwd-icon {
...
.elfinder-cwd-view-list .elfinder-navbar-root-ftp td .elfinder-cwd-icon  {
	background-image:asset-url("#{$elfinder-img-path}/volume_icon_ftp.png");
	background-position:0 0;
	background-size: contain;
}
.elfinder-cwd .elfinder-navbar-root-ftp.elfinder-droppable-active .elfinder-cwd-icon {
...
.elfinder-cwd-view-list .elfinder-navbar-root-sql td .elfinder-cwd-icon  {
	background-image:asset-url("#{$elfinder-img-path}/volume_icon_sql.png");
	background-position:0 0;
	background-size: contain;
}
.elfinder-cwd .elfinder-navbar-root-sql.elfinder-droppable-active .elfinder-cwd-icon {
...
.elfinder-cwd-view-list .elfinder-navbar-root-dropbox td .elfinder-cwd-icon  {
	background-image:asset-url("#{$elfinder-img-path}/volume_icon_dropbox.png");
	background-position:0 0;
	background-size: contain;
}
.elfinder-cwd .elfinder-navbar-root-dropbox.elfinder-droppable-active .elfinder-cwd-icon {
...
.elfinder-cwd-view-list .elfinder-navbar-root-googledrive td .elfinder-cwd-icon  {
	background-image:asset-url("#{$elfinder-img-path}/volume_icon_googledrive.png");
	background-position:0 0;
	background-size: contain;
}
...
.elfinder-cwd-view-list .elfinder-navbar-root-onedrive td .elfinder-cwd-icon  {
	background-image:asset-url("#{$elfinder-img-path}/volume_icon_onedrive.png");
	background-position:0 0;
	background-size: contain;
}
...
.elfinder-cwd-view-list .elfinder-navbar-root-box td .elfinder-cwd-icon  {
	background-image:asset-url("#{$elfinder-img-path}/volume_icon_box.png");
	background-position:0 0;
	background-size: contain;
}
...
.elfinder-cwd-view-list .elfinder-navbar-root-zip td .elfinder-cwd-icon  {
	background-image:asset-url("#{$elfinder-img-path}/volume_icon_zip.png");
	background-position:0 0;
	background-size: contain;
}
.elfinder-cwd .elfinder-navbar-root-googledrive.elfinder-droppable-active .elfinder-cwd-icon,
...
/* icon image has type */
.elfinder-cwd-icon.elfinder-cwd-icon-x-empty:before,
.elfinder-cwd-icon.elfinder-cwd-icon-plain:before,
.elfinder-cwd-icon.elfinder-cwd-icon-rtf:before,
.elfinder-cwd-icon.elfinder-cwd-icon-rtfd:before,
.elfinder-cwd-icon.elfinder-cwd-icon-pdf:before,
.elfinder-cwd-icon.elfinder-cwd-icon-html:before,
.elfinder-cwd-icon.elfinder-cwd-icon-css:before,
.elfinder-cwd-icon.elfinder-cwd-icon-javascript:before,
.elfinder-cwd-icon.elfinder-cwd-icon-x-javascript:before,
.elfinder-cwd-icon.elfinder-cwd-icon-x-perl:before,
.elfinder-cwd-icon.elfinder-cwd-icon-x-python:before,
.elfinder-cwd-icon.elfinder-cwd-icon-x-ruby:before,
.elfinder-cwd-icon.elfinder-cwd-icon-x-sh:before,
.elfinder-cwd-icon.elfinder-cwd-icon-x-shellscript:before,
.elfinder-cwd-icon.elfinder-cwd-icon-x-c:before,
.elfinder-cwd-icon.elfinder-cwd-icon-x-csrc:before,
.elfinder-cwd-icon.elfinder-cwd-icon-x-chdr:before,
.elfinder-cwd-icon.elfinder-cwd-icon-x-c--:before,
.elfinder-cwd-icon.elfinder-cwd-icon-x-c--src:before,
.elfinder-cwd-icon.elfinder-cwd-icon-x-c--hdr:before,
.elfinder-cwd-icon.elfinder-cwd-icon-x-java:before,
.elfinder-cwd-icon.elfinder-cwd-icon-x-java-source:before,
.elfinder-cwd-icon.elfinder-cwd-icon-x-php:before,
.elfinder-cwd-icon.elfinder-cwd-icon-xml:before,
.elfinder-cwd-icon.elfinder-cwd-icon-zip:before,
.elfinder-cwd-icon.elfinder-cwd-icon-x-zip:before,
.elfinder-cwd-icon.elfinder-cwd-icon-x-xz:before,
.elfinder-cwd-icon.elfinder-cwd-icon-x-7z-compressed:before,
.elfinder-cwd-icon.elfinder-cwd-icon-x-gzip:before,
.elfinder-cwd-icon.elfinder-cwd-icon-x-tar:before,
.elfinder-cwd-icon.elfinder-cwd-icon-x-bzip:before,
.elfinder-cwd-icon.elfinder-cwd-icon-x-bzip2:before,
.elfinder-cwd-icon.elfinder-cwd-icon-x-rar:before,
.elfinder-cwd-icon.elfinder-cwd-icon-x-rar-compressed:before,
.elfinder-cwd-icon.elfinder-cwd-icon-x-shockwave-flash:before { content: none }

/* addtional type badge name */
.elfinder-cwd-icon.elfinder-cwd-icon-mp2t:before { content: 'ts' }
.elfinder-cwd-icon.elfinder-cwd-icon-dash-xml:before { content: 'dash' }
.elfinder-cwd-icon.elfinder-cwd-icon-x-mpegurl:before { content: 'hls' }
...
.elfinder-cwd-view-list td .elfinder-cwd-icon {
	...
	top:50%;
	margin-top:-8px;
	background-image:asset-url("#{$elfinder-img-path}/icons-small.png");
}
...
.elfinder-cwd-wrapper-trash .elfinder-cwd-message-board {
	background-image: asset-url("#{$elfinder-img-path}/trashmesh.png");
}
...
.elfinder-spinner { 
	width:14px;
	height:14px;
	background: asset-url("#{$elfinder-img-path}/spinner-mini.gif") center center no-repeat;
	margin:0 5px;
	display: inline-block;
...
.elfinder-dialog-icon {
	...
	top:50%;
	margin-top:-15px;
	background: asset-url("#{$elfinder-img-path}/dialogs.png") 0 0 no-repeat;
}
...
.elfinder-notify-progress {
	width:100%;
	height:8px;
	background:asset-url("#{$elfinder-img-path}/progress.gif") center center repeat-x;
}
...
.elfinder-navbar-arrow {
	...
	top:50%;
	margin-top:-8px;
	background-image:asset-url("#{$elfinder-img-path}/arrows-normal.png");
	background-repeat:no-repeat;
...
.ui-state-active .elfinder-navbar-arrow { background-image:asset-url("#{$elfinder-img-path}/arrows-active.png"); }

/* collapsed/expanded arrow view */
.elfinder-navbar-collapsed .elfinder-navbar-arrow { display:block; }

.elfinder-subtree-chksubdir .elfinder-navbar-arrow { opacity: .25; filter:Alpha(Opacity=25); }
...
/* root icon of each volume */
.elfinder-tree .elfinder-navbar-root-local   .elfinder-navbar-icon { background-image:asset-url("#{$elfinder-img-path}/volume_icon_local.png"); background-position:0 0; }
.elfinder-tree .elfinder-navbar-root-trash   .elfinder-navbar-icon { background-image:asset-url("#{$elfinder-img-path}/volume_icon_trash.png"); background-position:0 0; }
.elfinder-tree .elfinder-navbar-root-ftp     .elfinder-navbar-icon { background-image:asset-url("#{$elfinder-img-path}/volume_icon_ftp.png"); background-position:0 0; }
.elfinder-tree .elfinder-navbar-root-sql     .elfinder-navbar-icon { background-image:asset-url("#{$elfinder-img-path}/volume_icon_sql.png"); background-position:0 0; }
.elfinder-tree .elfinder-navbar-root-dropbox .elfinder-navbar-icon { background-image:asset-url("#{$elfinder-img-path}/volume_icon_dropbox.png"); background-position:0 0; }
.elfinder-tree .elfinder-navbar-root-googledrive .elfinder-navbar-icon { background-image:asset-url("#{$elfinder-img-path}/volume_icon_googledrive.png"); background-position:0 0; }
.elfinder-tree .elfinder-navbar-root-onedrive .elfinder-navbar-icon { background-image:asset-url("#{$elfinder-img-path}/volume_icon_onedrive.png"); background-position:0 0; }
.elfinder-tree .elfinder-navbar-root-box .elfinder-navbar-icon { background-image:asset-url("#{$elfinder-img-path}/volume_icon_box.png"); background-position:0 0; }
.elfinder-tree .elfinder-navbar-root-zip .elfinder-navbar-icon { background-image:asset-url("#{$elfinder-img-path}/volume_icon_zip.png"); background-position:0 0; }
.elfinder-tree .elfinder-navbar-root-network .elfinder-navbar-icon { background-image:asset-url("#{$elfinder-img-path}/toolbar.png"); background-position: 0 -688px; }
...
/* resizable */
.elfinder-navbar .ui-resizable-handle { width:12px; background:transparent asset-url("#{$elfinder-img-path}/resize.png") center center no-repeat; }
...
.elfinder-quicklook {
	position:absolute;
	background:asset-url("#{$elfinder-img-path}/quicklook-bg.png");
	overflow:hidden;
...
.elfinder-quicklook .ui-resizable-se {
	...
	right:5px;
	bottom:3px;
	background:asset-url("#{$elfinder-img-path}/toolbar.png") 0 -496px no-repeat;
}
...
.elfinder-quicklook-navbar-icon {
	...
	margin:0 7px;
	float:left;
	background:asset-url("#{$elfinder-img-path}/quicklook-icons.png") 0 0 no-repeat;
...
.elfinder-button-icon {
	...
	/*display:block;*/
	display:inline-block;
	background:asset-url("#{$elfinder-img-path}/toolbar.png")  no-repeat;
}
...
.elfinder-button-icon-mkdirin   { background-position: 0 -912px; }
.elfinder-button-icon-selectall { background-position: 0 -928px; }
.elfinder-button-icon-selectnone { background-position: 0 -944px; }
.elfinder-button-icon-selectinvert { background-position: 0 -960px; }
.elfinder-button-icon-opennew   { background-position: 0 -976px; }

/* button with dropdown menu*/
.elfinder .elfinder-menubutton { overflow:visible; }

/* button with spinner icon */
.elfinder-button-icon-spinner  { background: asset-url("#{$elfinder-img-path}/spinner-mini.gif") center center no-repeat; }
